...
import {
  fetchEventDetails,
  fetchAllEvents,
} from "../../utilities/fetchSingleEventData.js";

export const ConcertsCard = () => {
  const [events, setEvents] = useState([]);

  useEffect(() => {
    fetchAllEvents("Concerts").then((response) => {
      console.log("Concerts response:", response);
      ...
      console.log("Concerts response after conversion:", response);
      setEvents(response);
    });
  }, []);
